export default function HomePage() {
  const products = ["personalized embroidery kits","custom paint-by-numbers sets","DIY candle-making kits"];
    ...
    <main>
      ...
      <section style={{ background: "var(--primary)", color: "#fff", padding: "6rem 2rem", textAlign: "center" }}>
        <h1 style={{ fontSize: "clamp(2rem, 5vw, 3.5rem)", fontWeight: 800, marginBottom: "1rem" }}>
          Craft Your Unique Masterpiece Today
        </h1>
        <p style={{ fontSize: "1.2rem", maxWidth: "600px", margin: "0 auto 2rem", opacity: 0.9 }}>
          Explore our personalized kits and bring your artistic vision to life.
        </p>
        <a
          href="/products"
      ...
      <section style={{ padding: "4rem 2rem", maxWidth: "1100px", margin: "0 auto" }}>
        <h2 style={{ textAlign: "center", fontSize: "2rem", fontWeight: 700, marginBottom: "3rem" }}>Why Crafty Creations?</h2>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "2rem" }}>
          {["Premium Quality", "Fast Shipping", "100% Satisfaction Guarantee"].map((f) => (
            <div key={f} style={{ padding: "2rem", border: "1px solid #eee", borderRadius: "12px", textAlign: "center" }}>
              ...
              <p style={{ color: "#666" }}>We stand behind every product we sell, made for hobbyists, DIY enthusiasts, and gift shoppers looking for unique, personalized items.</p>
            </div>
          ))}
        </div>
      </section>
            ...
            {products.map((p: string, i: number) => (
              <div key={i} style={{ background: "#fff", border: "1px solid #eee", borderRadius: "12px", overflow: "hidden" }}>
                ...
                <div style={{ padding: "1.5rem" }}>
                  ...
                  <p style={{ color: "#666", marginBottom: "1rem", fontSize: "0.9rem" }}>Perfect for hobbyists, DIY enthusiasts, and gift shoppers looking for unique, personalized items</p>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <span style={{ fontWeight: 700, color: "var(--primary)" }}>$20</span>
