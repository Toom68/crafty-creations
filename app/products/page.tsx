export default function ProductsPage() {
  ...
  return (
    <main style={{ maxWidth: "1100px", margin: "0 auto", padding: "3rem 2rem" }}>
      ...
      <p style={{ color: "#666", marginBottom: "3rem" }}>Curated customizable arts and crafts kits products for hobbyists, DIY enthusiasts, and gift shoppers looking for unique, personalized items</p>
        ...
        {products.map((p: string, i: number) => (
          <div key={i} style={{ border: "1px solid #eee", borderRadius: "12px", overflow: "hidden" }}>
            ...
            <div style={{ padding: "1.5rem" }}>
              ...
              <p style={{ color: "#666", fontSize: "0.875rem", marginBottom: "1rem" }}>High quality customizable arts and crafts kits product. Loved by hobbyists, DIY enthusiasts, and gift shoppers looking for unique, personalized items.</p>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <span style={{ fontWeight: 700, color: "var(--primary)" }}>$20-$60</span>
